...
async def test_filter_mobile_device_action(mock_context: SupernotificationConfiguration):
    uut: Snoozer = Snoozer()
    uut.register_snooze(
        CommandType.SNOOZE,
...
async def test_check_notification_for_snooze_qualified(mock_context: SupernotificationConfiguration):
    uut: Snoozer = Snoozer()

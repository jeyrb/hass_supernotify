...
async def test_deliver(mock_hass) -> None:
    ...
    uut = ChimeDeliveryMethod(
        mock_hass, context, {"chimes": {CONF_METHOD: METHOD_CHIME,
                                   CONF_DEFAULT: True,
    ...
    mock_hass.services.async_call.assert_any_call("switch", "turn_on", service_data={
...
async def test_deliver_alias(mock_hass) -> None:
    ...
    mock_hass.services.async_call.assert_any_call("media_player", "play_media", service_data={
...
async def test_deliver_to_group(mock_hass) -> None:
    ...
    mock_hass.services.async_call.assert_any_call("switch", "turn_on", service_data={
        "entity_id": "switch.bell_1"})
    mock_hass.services.async_call.assert_any_call("media_player", "play_media",
